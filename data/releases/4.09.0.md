...
- [#2237](https://github.com/ocaml/ocaml/issues/2237 - [403 Forbidden]), [#8582](https://github.com/ocaml/ocaml/issues/8582): Reorder linearisation of Trywith to avoid a call instruction
...
- [#2265](https://github.com/ocaml/ocaml/issues/2265 - [403 Forbidden]): Add bytecomp/opcodes.mli
  (Mark Shinwell, review by Nicolas Ojeda Bar)

- [#2268](https://github.com/ocaml/ocaml/issues/2268 - [403 Forbidden]): Improve packing mechanism used for building compilerlibs modules
...
- [#8514](https://github.com/ocaml/ocaml/issues/8514 - [403 Forbidden]): Use boot/ocamlc.opt for building, if available.
...
- [#2296](https://github.com/ocaml/ocaml/issues/2296 - [403 Forbidden]): Fix parsing of hexadecimal floats with underscores in the exponent.
  (Hugo Heuzard and Xavier Leroy, review by Gabriel Scherer)

- [#8800](https://github.com/ocaml/ocaml/issues/8800 - [403 Forbidden]): Fix soundness bug in extension constructor inclusion
  (Leo White, review by Jacques Garrigue)

- [#8848](https://github.com/ocaml/ocaml/issues/8848 - [403 Forbidden]): Fix x86 stack probe CFI information in caml_c_call and
  caml_call_gc
  (Tom Kelly, review by Xavier Leroy)


- [#7156](https://github.com/ocaml/ocaml/issues/7156), [#8594](https://github.com/ocaml/ocaml/issues/8594 - [403 Forbidden]): make top level use custom printers if they are available
...
- [#7937](https://github.com/ocaml/ocaml/issues/7937), [#2287](https://github.com/ocaml/ocaml/issues/2287 - [403 Forbidden]): fix uncaught Unify exception when looking for type
  declaration
  (Florian Angeletti, review by Jacques Garrigue)

- [#8610](https://github.com/ocaml/ocaml/issues/8610), [#8613](https://github.com/ocaml/ocaml/issues/8613 - [403 Forbidden]): toplevel printing, consistent deduplicated name for types
  (Florian Angeletti, review by Thomas Refis and Gabriel Scherer,
   reported by Xavier Clerc)

- [#8635](https://github.com/ocaml/ocaml/issues/8635), [#8636](https://github.com/ocaml/ocaml/issues/8636 - [403 Forbidden]): Fix a bad side-effect of the -allow-approx option of
  ocamldep. It used to turn some errors into successes
  (Jérémie Dimino)

- [#8701](https://github.com/ocaml/ocaml/issues/8701), [#8725](https://github.com/ocaml/ocaml/issues/8725 - [403 Forbidden]): Variance of constrained parameters causes principality issues
  (Jacques Garrigue, report by Leo White, review by Gabriel Scherer)

- [#8777](https://github.com/ocaml/ocaml/issues/8777 - [403 Forbidden])(partial): fix position information in some polymorphic variant
  error messages about missing tags
  (Florian Angeletti, review by Thomas Refis)

- [#8779](https://github.com/ocaml/ocaml/issues/8779 - [403 Forbidden]), more cautious variance computation to avoid missing cmis
  (Florian Angeletti, report by Antonio Nuno Monteiro, review by Leo White)

- [#8810](https://github.com/ocaml/ocaml/issues/8810 - [403 Forbidden]): Env.lookup_module: don't allow creating loops
  (Thomas Refis, report by Leo White, review by Jacques Garrigue)

- [#8862](https://github.com/ocaml/ocaml/issues/8862), [#8871](https://github.com/ocaml/ocaml/issues/8871 - [403 Forbidden]): subst: preserve scopes
  (Thomas Refis, report by Leo White, review by Jacques Garrigue)
...
- [#8944](https://github.com/ocaml/ocaml/issues/8944 - [403 Forbidden]): Fix "open struct .. end" on clambda backend
