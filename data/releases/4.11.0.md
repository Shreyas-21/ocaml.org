...
- [Source
  tarball](https://github.com/ocaml/ocaml/archive/4.11.0.tar.gz - [403 Forbidden])
  (.tar.gz) for compilation under Unix (including Linux and MacOS X)
  and Microsoft Windows (including Cygwin).
- Also available in
  [.zip](https://github.com/ocaml/ocaml/archive/4.11.0.zip - [403 Forbidden])
  format.
...
- [#9096](https://github.com/ocaml/ocaml/issues/9096 - [403 Forbidden]): Print function names in backtraces.
  Old output:
```
...
- [#9230](https://github.com/ocaml/ocaml/issues/9230 - [403 Forbidden]), [#9362](https://github.com/ocaml/ocaml/issues/9362 - [403 Forbidden]): Memprof support for native allocations.
  (Jacques-Henri Jourdan and Stephen Dolan, review by Gabriel Scherer)

- [#8920](https://github.com/ocaml/ocaml/issues/8920 - [403 Forbidden]), [#9238](https://github.com/ocaml/ocaml/issues/9238 - [403 Forbidden]), [#9239](https://github.com/ocaml/ocaml/issues/9239 - [403 Forbidden]), [#9254](https://github.com/ocaml/ocaml/issues/9254 - [403 Forbidden]), [#9458](https://github.com/ocaml/ocaml/issues/9458 - [403 Forbidden]): New API for statistical memory profiling
...
- [#9353](https://github.com/ocaml/ocaml/issues/9353 - [403 Forbidden]): Reimplement `output_value` and the `Marshal.to_*` functions
...
- [#9233](https://github.com/ocaml/ocaml/issues/9233 - [403 Forbidden]): Restore the bytecode stack after an allocation.
  (Stephen Dolan, review by Gabriel Scherer and Jacques-Henri Jourdan)

- [#9249](https://github.com/ocaml/ocaml/issues/9249 - [403 Forbidden]): restore definition of ARCH_ALIGN_INT64 in m.h if the architecture
...
- [#9279](https://github.com/ocaml/ocaml/issues/9279 - [403 Forbidden]): Memprof optimisation.
  (Stephen Dolan, review by Jacques-Henri Jourdan)

- [#9280](https://github.com/ocaml/ocaml/issues/9280 - [403 Forbidden]): Micro-optimise allocations on amd64 to save a register.
  (Stephen Dolan, review by Xavier Leroy)

- [#9426](https://github.com/ocaml/ocaml/issues/9426 - [403 Forbidden]): build the Mingw ports with higher levels of GCC optimization
  (Xavier Leroy, review by Sébastien Hinderer)

* \[*breaking change*\] [#9483](https://github.com/ocaml/ocaml/issues/9483 - [403 Forbidden]): Remove accidental inclusion of <stdio.h> in <caml/misc.h>
...
- [#9282](https://github.com/ocaml/ocaml/issues/9282 - [403 Forbidden]): Make Cconst_symbol have typ_int to fix no-naked-pointers mode.
  (Stephen Dolan, review by Mark Shinwell, Xavier Leroy and Vincent Laviron)

- [#9497](https://github.com/ocaml/ocaml/issues/9497 - [403 Forbidden]): Harmonise behaviour between bytecode and native code for
  recursive module initialisation in one particular case (fixes [#9494](https://github.com/ocaml/ocaml/issues/9494 - [403 Forbidden])).
  (Mark Shinwell, David Allsopp, Vincent Laviron, Xavier Leroy,
  Geoff Reedy, original bug report by Arlen Cox)

- [#8791](https://github.com/ocaml/ocaml/issues/8791 - [403 Forbidden]): use a variable-length encoding when marshalling bigarray dimensions,
  avoiding overflow.
  (Jeremy Yallop, Stephen Dolan, review by Xavier Leroy)

### Code generation and optimizations:

- [#9441](https://github.com/ocaml/ocaml/issues/9441 - [403 Forbidden]): Add RISC-V RV64G native-code backend.
  (Nicolás Ojeda Bär, review by Xavier Leroy and Gabriel Scherer)

- [#9316](https://github.com/ocaml/ocaml/issues/9316 - [403 Forbidden]), [#9443](https://github.com/ocaml/ocaml/issues/9443 - [403 Forbidden]), [#9463](https://github.com/ocaml/ocaml/issues/9463 - [403 Forbidden]), [#9782](https://github.com/ocaml/ocaml/issues/9782 - [403 Forbidden]): Use typing information from Clambda
...
- [#8637](https://github.com/ocaml/ocaml/issues/8637 - [403 Forbidden]), [#8805](https://github.com/ocaml/ocaml/issues/8805 - [403 Forbidden]), [#9247](https://github.com/ocaml/ocaml/issues/9247 - [403 Forbidden]), [#9296](https://github.com/ocaml/ocaml/issues/9296 - [403 Forbidden]): Record debug info for each allocation.
  (Stephen Dolan and Jacques-Henri Jourdan, review by Damien Doligez,
   KC Sivaramakrishnan and Xavier Leroy)


- [#9193](https://github.com/ocaml/ocaml/issues/9193 - [403 Forbidden]): Make tuple matching optimisation apply to Lswitch and Lstringswitch.
  (Stephen Dolan, review by Thomas Refis and Gabriel Scherer)

- [#9392](https://github.com/ocaml/ocaml/issues/9392 - [403 Forbidden]): Visit registers at most once in Coloring.iter_preferred.
  (Stephen Dolan, review by Pierre Chambart and Xavier Leroy)

- [#9549](https://github.com/ocaml/ocaml/issues/9549 - [403 Forbidden]), [#9557](https://github.com/ocaml/ocaml/issues/9557 - [403 Forbidden]): Make -flarge-toc the default for PowerPC and introduce
  -fsmall-toc to enable the previous behaviour.
  (David Allsopp, report by Nathaniel Wesley Filardo, review by Xavier Leroy)

### Language features

- [#8820](https://github.com/ocaml/ocaml/issues/8820 - [403 Forbidden]), [#9166](https://github.com/ocaml/ocaml/issues/9166 - [403 Forbidden]): quoted extensions: {%foo|...|} is lighter syntax for
  [%foo {||}], and {%foo bar|...|bar} for [%foo {bar|...|bar}].
  (Gabriel Radanne, Leo White, Gabriel Scherer and Pieter Goetschalckx,
   request by Bikal Lem)

- [#7364](https://github.com/ocaml/ocaml/issues/7364 - [403 Forbidden]), [#2188](https://github.com/ocaml/ocaml/issues/2188 - [403 Forbidden]), [#9592](https://github.com/ocaml/ocaml/issues/9592 - [403 Forbidden]), [#9609](https://github.com/ocaml/ocaml/issues/9609 - [403 Forbidden]): improvement of the unboxability check for types
...
- [#1154](https://github.com/ocaml/ocaml/issues/1154 - [403 Forbidden]), [#1706](https://github.com/ocaml/ocaml/issues/1706 - [403 Forbidden]): spellchecker hints and type-directed disambiguation
  for extensible sum type constructors
  (Florian Angeletti, review by Alain Frisch, Gabriel Radanne, Gabriel Scherer
  and Leo White)


- [#6673](https://github.com/ocaml/ocaml/issues/6673 - [403 Forbidden]), [#1132](https://github.com/ocaml/ocaml/issues/1132 - [403 Forbidden]), [#9617](https://github.com/ocaml/ocaml/issues/9617 - [403 Forbidden]): Relax the handling of explicit polymorphic types.
...
- [#9232](https://github.com/ocaml/ocaml/issues/9232 - [403 Forbidden]): allow any class type paths in #-types,
  For instance, "val f: #F(X).t -> unit" is now allowed.
  (Florian Angeletti, review by Gabriel Scherer, suggestion by Leo White)

### Standard library:

- [#9077](https://github.com/ocaml/ocaml/issues/9077 - [403 Forbidden]): Add Seq.cons and Seq.append
  (Sébastien Briais, review by Yawar Amin and Florian Angeletti)

- [#9235](https://github.com/ocaml/ocaml/issues/9235 - [403 Forbidden]): Add Array.exists2 and Array.for_all2
  (Bernhard Schommer, review by Armaël Guéneau)

- [#9226](https://github.com/ocaml/ocaml/issues/9226 - [403 Forbidden]): Add Seq.unfold.
   (Jeremy Yallop, review by Hezekiah M. Carty, Gabriel Scherer and
   Gabriel Radanne)

- [#9059](https://github.com/ocaml/ocaml/issues/9059 - [403 Forbidden]): Added List.filteri function, same as List.filter but
  with the index of the element.
  (Léo Andrès, review by Alain Frisch)

- [#8894](https://github.com/ocaml/ocaml/issues/8894 - [403 Forbidden]): Added List.fold_left_map function combining map and fold.
  (Bernhard Schommer, review by Alain Frisch and github user @cfcs)

- [#9365](https://github.com/ocaml/ocaml/issues/9365 - [403 Forbidden]): Set.filter_map and Map.filter_map
  (Gabriel Scherer, review by Stephen Dolan and Nicolás Ojeda Bär)


- [#9248](https://github.com/ocaml/ocaml/issues/9248 - [403 Forbidden]): Add Printexc.default_uncaught_exception_handler
  (Raphael Sousa Santos, review by Daniel Bünzli)

- [#8771](https://github.com/ocaml/ocaml/issues/8771 - [403 Forbidden]): Lexing: add set_position and set_filename to change (fake)
...
- [#9237](https://github.com/ocaml/ocaml/issues/9237 - [403 Forbidden]): `Format.pp_update_geometry ppf (fun geo -> {geo with ...})`
...
- [#7110](https://github.com/ocaml/ocaml/issues/7110 - [403 Forbidden]): Added Printf.ikbprintf and Printf.ibprintf
  (Muskan Garg, review by Gabriel Scherer and Florian Angeletti)

- [#9266](https://github.com/ocaml/ocaml/issues/9266 - [403 Forbidden]): Install pretty-printer for the exception Fun.Finally_raised.
  (Guillaume Munch-Maccagnoni, review by Daniel Bünzli, Gabriel Radanne,
   and Gabriel Scherer)

### Other libraries:

- [#9106](https://github.com/ocaml/ocaml/issues/9106 - [403 Forbidden]): Register printer for Unix_error in win32unix, as in unix.
  (Christopher Zimmermann, review by David Allsopp)

- [#9183](https://github.com/ocaml/ocaml/issues/9183 - [403 Forbidden]): Preserve exception backtrace of exceptions raised by top-level phrases
  of dynlinked modules.
  (Nicolás Ojeda Bär, review by Xavier Clerc and Gabriel Scherer)

- [#9320](https://github.com/ocaml/ocaml/issues/9320 - [403 Forbidden]), [#9550](https://github.com/ocaml/ocaml/issues/9550 - [403 Forbidden]): under Windows, make sure that the Unix.exec* functions
  properly quote their argument lists.
  (Xavier Leroy, report by André Maroneze, review by Nicolás Ojeda Bär
   and David Allsopp)

- [#9490](https://github.com/ocaml/ocaml/issues/9490 - [403 Forbidden]), [#9505](https://github.com/ocaml/ocaml/issues/9505 - [403 Forbidden]): ensure proper rounding of file times returned by
...
- [#9283](https://github.com/ocaml/ocaml/issues/9283 - [403 Forbidden]), [#9455](https://github.com/ocaml/ocaml/issues/9455 - [403 Forbidden]), [#9457](https://github.com/ocaml/ocaml/issues/9457 - [403 Forbidden]): add a new toplevel directive `#use_output "<command>"` to
  run a command and evaluate its output.
  (Jérémie Dimino, review by David Allsopp)


- [#6969](https://github.com/ocaml/ocaml/issues/6969 - [403 Forbidden]): Argument -nocwd added to ocamldep
  (Muskan Garg, review by Florian Angeletti)

- [#8676](https://github.com/ocaml/ocaml/issues/8676 - [403 Forbidden]), [#9594](https://github.com/ocaml/ocaml/issues/9594 - [403 Forbidden]): turn debugger off in programs launched by the program
  being debugged
  (Xavier Leroy, report by Michael Soegtrop, review by Gabriel Scherer)

- [#9057](https://github.com/ocaml/ocaml/issues/9057 - [403 Forbidden]): aid debugging the debugger by preserving backtraces of unhandled
  exceptions.
  (David Allsopp, review by Gabriel Scherer)

- [#9276](https://github.com/ocaml/ocaml/issues/9276 - [403 Forbidden]): objinfo: cm[x]a print extra C options, objects and dlls in
...
* \[*breaking change*\] [#9197](https://github.com/ocaml/ocaml/issues/9197 - [403 Forbidden]): remove compatibility logic from [#244](https://github.com/ocaml/ocaml/issues/244 - [403 Forbidden]) that was designed to
...
- [#9207](https://github.com/ocaml/ocaml/issues/9207 - [403 Forbidden]), [#9210](https://github.com/ocaml/ocaml/issues/9210 - [403 Forbidden]): fix ocamlyacc to work correctly with up to 255 entry
  points to the grammar.
  (Andreas Abel, review by Xavier Leroy)

- [#9482](https://github.com/ocaml/ocaml/issues/9482 - [403 Forbidden]), [#9492](https://github.com/ocaml/ocaml/issues/9492 - [403 Forbidden]): use diversions (@file) to work around OS limitations
...
- [#9141](https://github.com/ocaml/ocaml/issues/9141 - [403 Forbidden]): beginning of the ocamltest reference manual
  (Sébastien Hinderer, review by Gabriel Scherer and Thomas Refis)

- [#9228](https://github.com/ocaml/ocaml/issues/9228 - [403 Forbidden]): Various Map documentation improvements: add missing key argument in
...
- [#9255](https://github.com/ocaml/ocaml/issues/9255 - [403 Forbidden]), [#9300](https://github.com/ocaml/ocaml/issues/9300 - [403 Forbidden]): reference chapter, split the expression grammar
  (Florian Angeletti, report by Harrison Ainsworth, review by Gabriel Scherer)

- [#9325](https://github.com/ocaml/ocaml/issues/9325 - [403 Forbidden]): documented base case for `List.for_all` and `List.exists`
  (Glenn Slotte, review by Florian Angeletti)

- [#9410](https://github.com/ocaml/ocaml/issues/9410 - [403 Forbidden]), [#9422](https://github.com/ocaml/ocaml/issues/9422 - [403 Forbidden]): replaced naive fibonacci example with gcd
  (Anukriti Kumar, review by San Vu Ngoc, Florian Angeletti, Léo Andrès)

- [#9541](https://github.com/ocaml/ocaml/issues/9541 - [403 Forbidden]): Add a documentation page for the instrumented runtime;
...
- [#9610](https://github.com/ocaml/ocaml/issues/9610 - [403 Forbidden]): manual, C FFI: naked pointers are deprecated, detail the
...
- [#9618](https://github.com/ocaml/ocaml/issues/9618 - [403 Forbidden]): clarify the Format documentation on the margin and maximum indentation
  limit
  (Florian Angeletti, review by Josh Berdine)


- [#8644](https://github.com/ocaml/ocaml/issues/8644 - [403 Forbidden]): fix formatting comment about @raise in stdlib's mli files
  (Élie Brami, review by David Allsopp)

- [#9327](https://github.com/ocaml/ocaml/issues/9327 - [403 Forbidden]), [#9401](https://github.com/ocaml/ocaml/issues/9401 - [403 Forbidden]): manual, fix infix attribute examples
  (Florian Angeletti, report by David Cadé, review by Gabriel Scherer)

- [#9403](https://github.com/ocaml/ocaml/issues/9403 - [403 Forbidden]): added a description for warning 67 and added a "." at the end of
  warnings for consistency.
  (Muskan Garg, review by Gabriel Scherer and Florian Angeletti)

- [#7708](https://github.com/ocaml/ocaml/issues/7708 - [403 Forbidden]), [#9580](https://github.com/ocaml/ocaml/issues/9580 - [403 Forbidden]): Ensure Stdlib documentation index refers to Stdlib.
  (Stephen Dolan, review by Florian Angeletti, report by Hannes Mehnert)

### Compiler user-interface and warnings:

- [#9712](https://github.com/ocaml/ocaml/issues/9712 - [403 Forbidden]): Update the version format to allow "~".
...
- [#9107](https://github.com/ocaml/ocaml/issues/9107 - [403 Forbidden]): improved error message for exceptions in module signature errors
  (Gabriel Scherer, review by Florian Angeletti)

- [#9208](https://github.com/ocaml/ocaml/issues/9208 - [403 Forbidden]): -dno-locations option to hide source locations (and debug events)
...
- [#9486](https://github.com/ocaml/ocaml/issues/9486 - [403 Forbidden]): Fix configuration for the Haiku operating system
...
- [#9246](https://github.com/ocaml/ocaml/issues/9246 - [403 Forbidden]): Avoid rechecking functor applications
...
- [#7917](https://github.com/ocaml/ocaml/issues/7917), [#9426](https://github.com/ocaml/ocaml/issues/9426 - [403 Forbidden]): Use GCC option -fexcess-precision=standard when available,
...
- [#9355](https://github.com/ocaml/ocaml/issues/9355 - [403 Forbidden]), [#9356](https://github.com/ocaml/ocaml/issues/9356 - [403 Forbidden]): ocamldebug, fix a fatal error when printing values
...
- [#9375](https://github.com/ocaml/ocaml/issues/9375 - [403 Forbidden]), [#9477](https://github.com/ocaml/ocaml/issues/9477 - [403 Forbidden]): add forgotten substitution when compiling anonymous modules
  (Thomas Refis, review by Frédéric Bour, report by Andreas Hauptmann)

- [#9384](https://github.com/ocaml/ocaml/issues/9384 - [403 Forbidden]), [#9385](https://github.com/ocaml/ocaml/issues/9385 - [403 Forbidden]): Fix copy scope bugs in substitutions
  (Leo White, review by Thomas Refis, report by Nick Roberts)

* \[*breaking change*\] [#9388](https://github.com/ocaml/ocaml/issues/9388 - [403 Forbidden]): Prohibit signature local types with constraints
  (Leo White, review by Jacques Garrigue)

- [#9406](https://github.com/ocaml/ocaml/issues/9406 - [403 Forbidden]), [#9409](https://github.com/ocaml/ocaml/issues/9409 - [403 Forbidden]): fix an error with packed module types from missing
  cmis.
  (Florian Angeletti, report by Thomas Leonard, review by Gabriel Radanne
   and Gabriel Scherer)

- [#9415](https://github.com/ocaml/ocaml/issues/9415 - [403 Forbidden]): Treat `open struct` as `include struct` in toplevel
  (Leo White, review by Thomas Refis)

- [#9416](https://github.com/ocaml/ocaml/issues/9416 - [403 Forbidden]): Avoid warning 58 in flambda ocamlnat
  (Leo White, review by Florian Angeletti)

- [#9420](https://github.com/ocaml/ocaml/issues/9420 - [403 Forbidden]): Fix memory leak when `caml_output_value_to_block` raises an exception
  (Xavier Leroy, review by Guillaume Munch-Maccagnoni)

- [#9428](https://github.com/ocaml/ocaml/issues/9428 - [403 Forbidden]): Fix truncated exception backtrace for C->OCaml callbacks
  on Power and Z System
  (Xavier Leroy, review by Nicolás Ojeda Bär)

- [#9623](https://github.com/ocaml/ocaml/issues/9623 - [403 Forbidden]), [#9642](https://github.com/ocaml/ocaml/issues/9642 - [403 Forbidden]): fix typing environments in Typedecl.transl_with_constraint
  (Gabriel Scherer, review by Jacques Garrigue and Leo White,
   report by Hugo Heuzard)

- [#9695](https://github.com/ocaml/ocaml/issues/9695 - [403 Forbidden]), [#9702](https://github.com/ocaml/ocaml/issues/9702 - [403 Forbidden]): no error when opening an alias to a missing module
  (Jacques Garrigue, report and review by Gabriel Scherer)

- [#9714](https://github.com/ocaml/ocaml/issues/9714 - [403 Forbidden]), [#9724](https://github.com/ocaml/ocaml/issues/9724 - [403 Forbidden]): Add a terminator to the `caml_domain_state` structure
