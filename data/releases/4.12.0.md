...
- [9066](https://github.com/ocaml/ocaml/issues/9066 - [403 Forbidden]): List.partition_map :
...
* [*breaking change*] [1128](https://github.com/ocaml/ocaml/issues/1128 - [403 Forbidden]), [7503](https://github.com/ocaml/ocaml/issues/7503), [9036](https://github.com/ocaml/ocaml/issues/9036), [9722](https://github.com/ocaml/ocaml/issues/9722 - [403 Forbidden]), [10069](https://github.com/ocaml/ocaml/issues/10069 - [403 Forbidden]): EINTR-based signal handling.
...
* [*breaking change*] [5154](https://github.com/ocaml/ocaml/issues/5154), [9569](https://github.com/ocaml/ocaml/issues/9569 - [403 Forbidden]), [9734](https://github.com/ocaml/ocaml/issues/9734 - [403 Forbidden]): Add `Val_none`, `Some_val`, `Is_none`, `Is_some`,
...
* [*breaking change*] [9206](https://github.com/ocaml/ocaml/issues/9206), [9419](https://github.com/ocaml/ocaml/issues/9419 - [403 Forbidden]): update documentation of the threads library;
...
- [9649](https://github.com/ocaml/ocaml/issues/9649 - [403 Forbidden]): Update the marshaler (output_value) to take advantage
  of the new representation for function closures
...
- [8807](https://github.com/ocaml/ocaml/issues/8807), [9503](https://github.com/ocaml/ocaml/issues/9503 - [403 Forbidden]): Use different symbols for do_local_roots on bytecode and native
...
- [9742](https://github.com/ocaml/ocaml/issues/9742 - [403 Forbidden]), [9989](https://github.com/ocaml/ocaml/issues/9989 - [403 Forbidden]): Ephemerons are now compatible with infix pointers occurring
   when using mutually recursive functions.
   (Jacques-Henri Jourdan, review by François Bobot)

- [9888](https://github.com/ocaml/ocaml/issues/9888), [9890](https://github.com/ocaml/ocaml/issues/9890 - [403 Forbidden]): Fixes a bug in the `riscv` backend where register t0 was not
...
- [9864](https://github.com/ocaml/ocaml/issues/9864 - [403 Forbidden]): Revised recognition of immediate arguments to integer operations.
...
- [9663](https://github.com/ocaml/ocaml/issues/9663 - [403 Forbidden]): Extend Printexc API for raw backtrace entries.
...
- [9338](https://github.com/ocaml/ocaml/issues/9338), [9790](https://github.com/ocaml/ocaml/issues/9790 - [403 Forbidden]): Dynlink: make sure *_units () functions report accurate
...
- [9906](https://github.com/ocaml/ocaml/issues/9906 - [403 Forbidden]), [9914](https://github.com/ocaml/ocaml/issues/9914 - [403 Forbidden]): Add Unix._exit as a way to exit the process immediately,
...
- [9971](https://github.com/ocaml/ocaml/issues/9971), [9973](https://github.com/ocaml/ocaml/issues/9973 - [403 Forbidden]): Make sure the process can terminate when the last thread
  calls Thread.exit.
...
- [10233](https://github.com/ocaml/ocaml/issues/10233 - [403 Forbidden]): Document `-save-ir-after scheduling` and update `-stop-after` options.
...
- [10008](https://github.com/ocaml/ocaml/issues/10008 - [403 Forbidden]): Improve error message for aliases to the current compilation unit.
  (Leo White, review by Gabriel Scherer)
...
- [9778](https://github.com/ocaml/ocaml/issues/9778 - [403 Forbidden]): Fix printing for bindings where polymorphic type annotations and
...
- [9527](https://github.com/ocaml/ocaml/issues/9527 - [403 Forbidden]): stop including configuration when running 'clean' rules
...
- [9421](https://github.com/ocaml/ocaml/issues/9421), [9427](https://github.com/ocaml/ocaml/issues/9427 - [403 Forbidden]): fix printing of (::) in ocamldoc
...
- [9681](https://github.com/ocaml/ocaml/issues/9681 - [403 Forbidden]), [9690](https://github.com/ocaml/ocaml/issues/9690), [9693](https://github.com/ocaml/ocaml/issues/9693): small runtime changes
...
- [9858](https://github.com/ocaml/ocaml/issues/9858 - [429 Too Many Requests]), [9861](https://github.com/ocaml/ocaml/issues/9861 - [429 Too Many Requests]): Compiler fails with Ctype.Nondep_cannot_erase exception
  (Thomas Refis, report by Philippe Veber, review by Florian Angeletti)

- [9860](https://github.com/ocaml/ocaml/issues/9860 - [429 Too Many Requests]): wrong range constraint for subtract immediate on zSystems / s390x
  (Xavier Leroy, review by Stephen Dolan)

- [9868](https://github.com/ocaml/ocaml/issues/9868 - [429 Too Many Requests]), [9872](https://github.com/ocaml/ocaml/issues/9872 - [429 Too Many Requests]), [9892](https://github.com/ocaml/ocaml/issues/9892 - [429 Too Many Requests]): bugs in {in,out}_channel_length and seek_in
  for files opened in text mode under Windows
  (Xavier Leroy, report by Alain Frisch, review by Nicolás Ojeda Bär
  and Alain Frisch)

- [9925](https://github.com/ocaml/ocaml/issues/9925 - [429 Too Many Requests]): Correct passing -fdebug-prefix-map to flexlink on Cygwin by prefixing
  it with -link.
  (David Allsopp, review by Xavier Leroy)

- [9927](https://github.com/ocaml/ocaml/issues/9927 - [429 Too Many Requests]): Restore Cygwin64 support.
  (David Allsopp, review by Xavier Leroy)

- [9940](https://github.com/ocaml/ocaml/issues/9940 - [429 Too Many Requests]): Fix unboxing of allocated constants from other compilation units
  (Vincent Laviron, report by Stephen Dolan, review by Xavier Leroy and
  Stephen Dolan)

- [9991](https://github.com/ocaml/ocaml/issues/9991 - [429 Too Many Requests]): Fix reproducibility for `-no-alias-deps`
  (Leo White, review by Gabriel Scherer and Florian Angeletti)

- [9998](https://github.com/ocaml/ocaml/issues/9998 - [429 Too Many Requests]): Use Sys.opaque_identity in CamlinternalLazy.force
...
- [9999](https://github.com/ocaml/ocaml/issues/9999 - [429 Too Many Requests]): fix -dsource printing of the pattern (`A as x | (`B as x)).
  (Gabriel Scherer, report by Anton Bachin, review by Florian Angeletti)

- [9970](https://github.com/ocaml/ocaml/issues/9970 - [429 Too Many Requests]), [10010](https://github.com/ocaml/ocaml/issues/10010 - [429 Too Many Requests]): fix the declaration scope of extensible-datatype constructors.
...
- [10048](https://github.com/ocaml/ocaml/issues/10048 - [429 Too Many Requests]): Fix bug with generalized local opens.
  (Leo White, review by Thomas Refis)

- [10106](https://github.com/ocaml/ocaml/issues/10106 - [429 Too Many Requests]), [10112](https://github.com/ocaml/ocaml/issues/10112 - [429 Too Many Requests]): some expected-type explanations where forgotten
