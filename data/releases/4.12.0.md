...
* [*breaking change*] [9206](https://github.com/ocaml/ocaml/issues/9206 - [403 Forbidden]), [9419](https://github.com/ocaml/ocaml/issues/9419 - [403 Forbidden]): update documentation of the threads library;
...
- [9587](https://github.com/ocaml/ocaml/issues/9587 - [1 Client error: Timeout was reached]): Arg: new Rest_all spec to get all rest arguments in a list
...
- [9663](https://github.com/ocaml/ocaml/issues/9663 - [1 Client error: Failure when receiving data from the peer]): Extend Printexc API for raw backtrace entries.
...
* [*breaking change*] [9299](https://github.com/ocaml/ocaml/issues/9299), [9795](https://github.com/ocaml/ocaml/issues/9795 - [1 Client error: Failure when receiving data from the peer]): ocamldep: do not process files during cli parsing. Fixes
...
* [*breaking change*] [9011](https://github.com/ocaml/ocaml/issues/9011): Do not create .a/.lib files when creating a .cmxa with no modules.
  macOS ar doesn't support creating empty .a files ([1094](https://github.com/ocaml/ocaml/issues/1094 - [1 Client error: Timeout was reached])) and MSVC doesn't
...
- [9615](https://github.com/ocaml/ocaml/issues/9615 - [1 Client error: Failure when receiving data from the peer]): Attach package type attributes to core_type.
...
- [6633](https://github.com/ocaml/ocaml/issues/6633 - [403 Forbidden]), [9673](https://github.com/ocaml/ocaml/issues/9673): Add hint when a module is used instead of a module type or
...
- [9751](https://github.com/ocaml/ocaml/issues/9751 - [1 Client error: Failure when receiving data from the peer]): Add warning 68. Pattern-matching depending on mutable state
...
- [10008](https://github.com/ocaml/ocaml/issues/10008 - [1 Client error: Timeout was reached]): Improve error message for aliases to the current compilation unit.
  (Leo White, review by Gabriel Scherer)
...
- [9715](https://github.com/ocaml/ocaml/issues/9715 - [1 Client error: Timeout was reached]): recheck scope escapes after normalising paths
...
- [9797](https://github.com/ocaml/ocaml/issues/9797 - [403 Forbidden]), [9849](https://github.com/ocaml/ocaml/issues/9849): Eliminate the routine use of external commands in ocamltest.
...
- [7902](https://github.com/ocaml/ocaml/issues/7902), [9556](https://github.com/ocaml/ocaml/issues/9556 - [1 Client error: Failure when receiving data from the peer]): Type-checker infers recursive type, even though -rectypes is
  off.
...
- [9681](https://github.com/ocaml/ocaml/issues/9681), [9690](https://github.com/ocaml/ocaml/issues/9690 - [403 Forbidden]), [9693](https://github.com/ocaml/ocaml/issues/9693): small runtime changes
...
- [9759](https://github.com/ocaml/ocaml/issues/9759), [9767](https://github.com/ocaml/ocaml/issues/9767 - [1 Client error: Timeout was reached]): Spurious GADT ambiguity without -principal
...
- [9925](https://github.com/ocaml/ocaml/issues/9925 - [1 Client error: Timeout was reached]): Correct passing -fdebug-prefix-map to flexlink on Cygwin by prefixing
  it with -link.
  (David Allsopp, review by Xavier Leroy)
...
- [10048](https://github.com/ocaml/ocaml/issues/10048 - [1 Client error: Timeout was reached]): Fix bug with generalized local opens.
  (Leo White, review by Thomas Refis)

- [10106](https://github.com/ocaml/ocaml/issues/10106 - [1 Client error: Failure when receiving data from the peer]), [10112](https://github.com/ocaml/ocaml/issues/10112): some expected-type explanations where forgotten
