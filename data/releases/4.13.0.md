...
- [#10013](https://github.com/ocaml/ocaml/issues/10013 - [403 Forbidden]): Let-punning
...
- [#10171](https://github.com/ocaml/ocaml/issues/10171 - [403 Forbidden]): Tweak the naked pointers checker so that processes which trigger the
...
- [#9937](https://github.com/ocaml/ocaml/issues/9937 - [403 Forbidden]): improvements in ARM64 code generation (constants, sign extensions)
  (Xavier Leroy, review by Stephen Dolan)
...
- [#944](https://github.com/ocaml/ocaml/issues/944 - [403 Forbidden]): Add some missing C99 float operations.  `Stdlib` now contains
...
- [#9448](https://github.com/ocaml/ocaml/issues/9448 - [403 Forbidden]): Add String.{empty,cat} as dual of Bytes.{empty,cat},
...
- [#9487](https://github.com/ocaml/ocaml/issues/9487 - [403 Forbidden]), [#9489](https://github.com/ocaml/ocaml/issues/9489 - [403 Forbidden]): Add Random.full_int which allows 62-bit bounds on 64-bit
  systems.
  (David Allsopp, request by Francois Berenger, review by Xavier Leroy and
   Damien Doligez)

- [#9533](https://github.com/ocaml/ocaml/issues/9533 - [403 Forbidden]): Added String.starts_with and String.ends_with.
  (Bernhard Schommer, review by Daniel Bünzli, Gabriel Scherer and
  Alain Frisch)

- [#9582](https://github.com/ocaml/ocaml/issues/9582 - [403 Forbidden]): Add Array.{find_opt,find_map,split,combine}.
  (Nicolás Ojeda Bär, review by Daniel Bünzli and Gabriel Scherer)

- [#9961](https://github.com/ocaml/ocaml/issues/9961 - [403 Forbidden]): Add Array.fold_left_map.
  (Craig Ferguson, review by Damien Doligez)

- [#10097](https://github.com/ocaml/ocaml/issues/10097 - [403 Forbidden]): Lazy.map, Lazy.map_val: ('a -> 'b) -> 'a Lazy.t -> 'b Lazy.t
...
* [*breaking change*] [#10169](https://github.com/ocaml/ocaml/issues/10169 - [403 Forbidden]), [#10270](https://github.com/ocaml/ocaml/issues/10270 - [403 Forbidden]), [#10301](https://github.com/ocaml/ocaml/issues/10301 - [403 Forbidden]), [#10451](https://github.com/ocaml/ocaml/issues/10451 - [403 Forbidden]): Use capitalized module names in the Standard
...
- [#10242](https://github.com/ocaml/ocaml/issues/10242 - [403 Forbidden]): Added convenience pretty printer for Either.t in the Format module.
  (Oghenevwogaga Ebresafe, review by Nicolás Ojeda Bär,
  Gabriel Scherer and Xavier Van de Woestyne)

- [#10352](https://github.com/ocaml/ocaml/issues/10352 - [403 Forbidden]): Seq.(concat : 'a t t -> 'a t)
...
- [#882](https://github.com/ocaml/ocaml/issues/882 - [403 Forbidden]): Add fold_left, fold_right, exists and for_all to String/Bytes
  (Yotam Barnoy, review by Alain Frisch and Jeremy Yallop)

- [#4070](https://github.com/ocaml/ocaml/issues/4070 - [403 Forbidden]), [#10398](https://github.com/ocaml/ocaml/issues/10398 - [403 Forbidden]): small optimization of Stdlib.{frexp,modf}.
  (Markus Mottl, Nicolás Ojeda Bär, review by Gabriel Scherer)

- [#10389](https://github.com/ocaml/ocaml/issues/10389 - [403 Forbidden]), [#10391](https://github.com/ocaml/ocaml/issues/10391 - [403 Forbidden]), [#10392](https://github.com/ocaml/ocaml/issues/10392 - [403 Forbidden]): Add {Int,Int32,Int64,Nativeint}.{min,max}.
  (Nicolás Ojeda Bär and Alain Frisch, review by Xavier Leroy)

- [#10430](https://github.com/ocaml/ocaml/issues/10430 - [403 Forbidden]): Add Format.print_bytes and Format.pp_print_bytes.
  (Gabriel Radanne, review by Gabriel Scherer and David Allsopp)

### Other libraries:

- [#10047](https://github.com/ocaml/ocaml/issues/10047 - [403 Forbidden]): Add `Unix.realpath`
  (Daniel Bünzli, review by David Allsopp, Josh Berdine and Gabriel Scherer)

* [*breaking change*] [#10084](https://github.com/ocaml/ocaml/issues/10084 - [403 Forbidden]): Unix.open_process_args* functions now look up the program in the PATH.
...
- [#10184](https://github.com/ocaml/ocaml/issues/10184 - [403 Forbidden]): Remove expensive debug assertion from dynlink.
  (Leo White, review by David Allsopp and Xavier Leroy)

- [#10185](https://github.com/ocaml/ocaml/issues/10185 - [403 Forbidden]): Consider that IPv6 is always enabled on Windows.
  (Antonin Décimo, review by David Allsopp and Xavier Leroy)

- [#10306](https://github.com/ocaml/ocaml/issues/10306 - [403 Forbidden]): Map WSA error code to Unix errno for sockopt and getsockname
  functions (Antonin Décimo, review by David Allsopp)

- [#10309](https://github.com/ocaml/ocaml/issues/10309 - [403 Forbidden]): Properly return EBADF on error in Unix.descr_of_{in,out}_channel on
...
- [#8645](https://github.com/ocaml/ocaml/issues/8645 - [403 Forbidden]), [#10363](https://github.com/ocaml/ocaml/issues/10363 - [403 Forbidden]): ocamldoc: escape `<`, `>`, and `&` in html backend.
