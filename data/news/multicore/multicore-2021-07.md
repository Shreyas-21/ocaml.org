...
* @emillon (Etienne Millon) for running the Jane Street `core` v0.14 test suite with 4.12.0+domains and sharing the test results (and finding a [multicore GC edge case bug](https://github.com/ocaml-multicore/ocaml-multicore/issues/624 - [429 Too Many Requests]) while at it).
...
All of these fixes, combined with some big-ticket compatibility changes (listed below) are getting me pretty close to using 4.12.0+domains as my daily OCaml opam switch of choice. I encourage you to also give it a try and report (good or bad) results on [the multicore OCaml tracker](https://github.com/ocaml-multicore/ocaml-multicore/issues - [429 Too Many Requests]).  If these sorts of problems grab your attention, then [Segfault Systems is hiring in India](https://segfault.systems/careers.html) to work with @kayceesrk and the team there on multicore OCaml.
...
* [ocaml-multicore/ocaml-multicore#602](https://github.com/ocaml-multicore/ocaml-multicore/issues/602 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#607](https://github.com/ocaml-multicore/ocaml-multicore/issues/607 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#608](https://github.com/ocaml-multicore/ocaml-multicore/issues/608 - [429 Too Many Requests])
  Parmap testsuite crash
  
  `Parmap` is causing a segfault when its testsuite is run against
  Multicore OCaml.

* [ocaml-multicore/ocaml-multicore#611](https://github.com/ocaml-multicore/ocaml-multicore/issues/611 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#609](https://github.com/ocaml-multicore/ocaml-multicore/issues/609 - [429 Too Many Requests])
  lablgtk's example segfaults
  
  An ongoing effort to compile lablgtk with OCaml and Multicore OCaml.

* [ocaml-multicore/ocaml-multicore#624](https://github.com/ocaml-multicore/ocaml-multicore/issues/624 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#625](https://github.com/ocaml-multicore/ocaml-multicore/issues/625 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#573](https://github.com/ocaml-multicore/ocaml-multicore/pull/573 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#617](https://github.com/ocaml-multicore/ocaml-multicore/issues/617 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#618](https://github.com/ocaml-multicore/ocaml-multicore/issues/618 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#623](https://github.com/ocaml-multicore/ocaml-multicore/pull/623 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#610](https://github.com/ocaml-multicore/ocaml-multicore/pull/610 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#614](https://github.com/ocaml-multicore/ocaml-multicore/issues/614 - [429 Too Many Requests])
  Destroy channel mutexes after fork
  
  A discussion on resetting and reinitializing mutexes after fork in
  the runtime.
  
* [ocaml-multicore/ocaml-multicore#616](https://github.com/ocaml-multicore/ocaml-multicore/pull/616 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#619](https://github.com/ocaml-multicore/ocaml-multicore/issues/619 - [429 Too Many Requests])
  Set resource Limit
...
* [ocaml-multicore/ocaml-multicore#601](https://github.com/ocaml-multicore/ocaml-multicore/pull/601 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#605](https://github.com/ocaml-multicore/ocaml-multicore/pull/605 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#615](https://github.com/ocaml-multicore/ocaml-multicore/pull/615 - [429 Too Many Requests])
  make depend
  
  Updated `stdlib/.depend` to cover the recent developments in stdlib.

* [ocaml-multicore/ocaml-multicore#626](https://github.com/ocaml-multicore/ocaml-multicore/pull/626 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#584](https://github.com/ocaml-multicore/ocaml-multicore/pull/584 - [429 Too Many Requests])
  Modernise signal handling

  The Multicore OCaml signals implementation is now closer to that of
  upstream OCaml.

* [ocaml-multicore/ocaml-multicore#600](https://github.com/ocaml-multicore/ocaml-multicore/pull/600 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#612](https://github.com/ocaml-multicore/ocaml-multicore/pull/612 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore$604](https://github.com/ocaml-multicore/ocaml-multicore/pull/604 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#621](https://github.com/ocaml-multicore/ocaml-multicore/pull/621 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#628](https://github.com/ocaml-multicore/ocaml-multicore/pull/628 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-multicore#629](https://github.com/ocaml-multicore/ocaml-multicore/pull/629 - [429 Too Many Requests])
...
* [ocaml-multicore/ocaml-uring#36](https://github.com/ocaml-multicore/ocaml-uring/pull/36 - [429 Too Many Requests])
  Update to cstruct 6.0.1
  
  ocaml-uring is now updated to use `Cstruct.shiftv` with the upgrade
  to cstruct.6.0.1.

* [ocaml-multicore/domainslib#37](https://github.com/ocaml-multicore/domainslib/issues/37 - [429 Too Many Requests])
  parallel_map
...
* [ocaml-multicore/domainslib#38](https://github.com/ocaml-multicore/domainslib/issues/38 - [429 Too Many Requests])
...
* [ocaml-multicore/eventlog-tools#4](https://github.com/ocaml-multicore/eventlog-tools/pull/4 - [429 Too Many Requests])
  Add `domain/condition_wait` event
  
  The `lib/consts.ml` file in eventlog-tools now includes the
  `domain/condition_wait` event.

* [ocaml-multicore/domainslib#34](https://github.com/ocaml-multicore/domainslib/pull/34 - [429 Too Many Requests])
...
* [ocaml-multicore/eio#68](https://github.com/ocaml-multicore/eio/pull/68 - [429 Too Many Requests])
...
* [ocaml-multicore/eio#62](https://github.com/ocaml-multicore/eio/pull/62 - [429 Too Many Requests])
...
* [ocaml-multicore/eio#63](https://github.com/ocaml-multicore/eio/pull/63 - [429 Too Many Requests])
  Update README
...
* [ocaml-multicore/eio#64](https://github.com/ocaml-multicore/eio/pull/64 - [429 Too Many Requests])
...
* [ocaml-multicore/eio#65](https://github.com/ocaml-multicore/eio/pull/65 - [429 Too Many Requests])
...
* [ocaml-multicore/eio#66](https://github.com/ocaml-multicore/eio/pull/66 - [429 Too Many Requests])
  Allow cancelling waiting for a semaphore
  
  Update to `lib_eio/semaphore.ml` to allow cancel waiting for a
  semaphore.

* [ocaml-multicore/eio#67](https://github.com/ocaml-multicore/eio/pull/67 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark-nightly#4](https://github.com/ocaml-bench/sandmark-nightly/issues/4 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark-nightly#5](https://github.com/ocaml-bench/sandmark-nightly/issues/5 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark-nightly#6](https://github.com/ocaml-bench/sandmark-nightly/issues/6 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark-nightly#7](https://github.com/ocaml-bench/sandmark-nightly/issues/7 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark-nightly#8](https://github.com/ocaml-bench/sandmark-nightly/issues/8 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark-nightly#9](https://github.com/ocaml-bench/sandmark-nightly/issues/9 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark-nightly#2](https://github.com/ocaml-bench/sandmark-nightly/issues/2 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark#243](https://github.com/ocaml-bench/sandmark/issues/243 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark#245](https://github.com/ocaml-bench/sandmark/pull/245 - [429 Too Many Requests])
  Add dune.2.9.0

  An update to dune.2.9.0 in order to build coq with Multicore OCaml
  on Sandmark.

* [ocaml-bench/sandmark#247](https://github.com/ocaml-bench/sandmark/issues/247 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark#248](https://github.com/ocaml-bench/sandmark/issues/248 - [429 Too Many Requests])
  coq fails to build
...
* [ocaml-bench/sandmark#233](https://github.com/ocaml-bench/sandmark/pull/233 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark#235](https://github.com/ocaml-bench/sandmark/issues/235 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark#237](https://github.com/ocaml-bench/sandmark/issues/237 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark#240](https://github.com/ocaml-bench/sandmark/pull/240 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark#242](https://github.com/ocaml-bench/sandmark/pull/242 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark#244](https://github.com/ocaml-bench/sandmark/pull/244 - [429 Too Many Requests])
...
* [ocaml-bench/sandmark#246](https://github.com/ocaml-bench/sandmark/pull/246 - [429 Too Many Requests])
...
* [ocurrent/current-bench#117](https://github.com/ocurrent/current-bench/issues/117 - [429 Too Many Requests])
...
* [ocurrent/current-bench#146](https://github.com/ocurrent/current-bench/issues/146 - [429 Too Many Requests])
