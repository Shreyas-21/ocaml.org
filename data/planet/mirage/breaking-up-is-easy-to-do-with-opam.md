...
<li><a href="http://github.com/mirage/dyntype">ocaml-dyntype</a> uses camlp4 to <a href="http://anil.recoil.org/papers/2011-dynamics-ml.pdf - [1 Client error: Server returned nothing (no headers, no data)]">generate dynamic types</a> and values from OCaml type declarations.
</li>
