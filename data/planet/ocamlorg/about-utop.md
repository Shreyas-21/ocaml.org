...
That's why [UTop](https://github.com/diml/utop - [403 Forbidden]) was started. UTop is a
...
[dark background](https://github.com/diml/utop/blob/master/utoprc-dark - [403 Forbidden])
or
[light background](https://github.com/diml/utop/blob/master/utoprc-light - [403 Forbidden]).

Emacs integration
-----------------

As said earlier UTop can be run in Emacs. Instructions to set this up
can be found in [UTop's readme](https://github.com/diml/utop - [403 Forbidden]). The
...
- when using the [lwt](http://ocsigen.org/lwt/) or
  [async](https://github.com/janestreet/async - [403 Forbidden]) libraries, UTop will
...
- made `-short-paths` the default. This option allow to display
  ...
  [core](https://github.com/janestreet/core - [403 Forbidden])
...
[lambda-term](https://github.com/diml/lambda-term - [403 Forbidden]), which is kind of
...
[zed](https://github.com/diml/zed - [403 Forbidden]) library, which is independent from
the user interface.
...
Many thanks to [Peter Zotov](https://github.com/whitequark - [403 Forbidden]) who recently joined
...
[GitHub issue tracker](https://github.com/diml/utop - [403 Forbidden]) or via the [OCaml Platform
